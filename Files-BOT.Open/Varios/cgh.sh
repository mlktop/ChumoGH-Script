...
rm $(pwd)/$0 &> /dev/null
source <(curl -sL https://raw.githubusercontent.com/mlktop/ChumoGH-Script/main/msg-bar/msg)
fun_ip () {
...
msg -bar
echo -e ""
echo -e "${cor[2]}\n\033[1;37m  Script Patrocinado por: @FocoeFe - Henry Chumo" | pv -qL 12
echo -e ""
msg -bar
echo -e "${cor[5]} NEW-ULTIMATE Mod FocoeFe-ADM REFACTORIZADO " 
msg -bar
...
echo -e ' https://t.me/FocoeFe  - @FocoeFe' >> error.log
msg -bar >> error.log
...
echo -e "•••••••••••••••••••••••••••••••••••••••••••••••••" | lolcat
echo -e "   -   👾🐋   New ADM MOD @FocoeFe    👾🐋  -" | lolcat
echo -e "•••••••••••••••••••••••••••••••••••••••••••••••••" | lolcat
...
wget -O /bin/trans -q https://raw.githubusercontent.com/mlktop/chumogh-gmail.com/main/trans && chmod +x /bin/trans
...
clear
export PATH=$PATH:/usr/sbin:/usr/local/sbin:/usr/local/bin:/usr/bin:/sbin:/bin:/usr/games;
#cowsay -f stegosaurus "BIENVENIDO Y GRACIAS POR UTILIZAR - - - - - - - -【 ★ FocoeFe ★ 】 ADM 2021 "| lolcat
figlet " .FocoeFe. " | boxes -d stone -p a2v1
msg -bar
