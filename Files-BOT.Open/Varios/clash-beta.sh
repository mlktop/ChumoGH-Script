...
[[ -e /root/name ]] && figlet -p -f slant < /root/name || echo -e "\033[7;49;35m    =====>>►► 🐲 New FocoeFe💥VPS 🐲 ◄◄<<=====      \033[0m"
echo -e "\033[1;37m      【     ★ FocoeFe - ADM 2021 ★     】\033[0m"
cd  /var/www/html
...
echo -e "[\033[1;31m-\033[1;33m]\033[1;30m =======================================\033[1;33m"
echo -e "\033[1;37m - Menu Iterativo Clash for Android - FocoeFe \033[0m"
...
echo -e "\033[1;37m      ã€      FocoeFe-ADM Mods.       ã€‘\033[0m"
...
rules:
- DOMAIN-SUFFIX,local,FocoeFe-ADM
- DOMAIN-SUFFIX,google.com,FocoeFe-ADM
- DOMAIN-KEYWORD,google,FocoeFe-ADM
- DOMAIN,google.com,FocoeFe-ADM
- DOMAIN-SUFFIX,ad.com,FocoeFe-ADM
- SRC-IP-CIDR,192.168.1.201/32,FocoeFe-ADM
- IP-CIDR,127.0.0.0/8,FocoeFe-ADM
- GEOIP,IR,FocoeFe-ADM
- DST-PORT,80,FocoeFe-ADM
- SRC-PORT,7777,FocoeFe-ADM
- MATCH, FocoeFe-ADM
...
sed -i 's/FocoeFe-ADM/✵ℂ𝕙𝕦𝕞𝕠𝔾ℍ-𝔸𝔻𝕄✵/g' /root/.config/clash/config.yaml
