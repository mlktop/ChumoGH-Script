#!/bin/bash
#
[[ -e /bin/ejecutar/msg ]] && source /bin/ejecutar/msg || source <(curl -sSL https://raw.githubusercontent.com/mlktop/ChumoGH-Script/main/msg-bar/msg)
...
brook link --server ws://$sni:${puerto} -p "$password" -u "@FocoeFe" --address "$domain" --name "@FocoeFe" --insecure 
fi
if [ -n "$ip6" ]; then
echo;
echo -e "$PC"">>> brook link -s [$ip6]:$puerto -p '$password'""$NC"
...
msg -bar 
echo
brook link --server wss://$sni:${puerto} -p "$password" -u "@FocoeFe" --address "$domain" --name "@FocoeFe" --insecure
echo
msg -bar
...
echo -e "\033[1;31m║                                             ║"
echo -e "\033[1;31m╠═════════════════════════════════════════════╣"
echo -e "\033[1;31m║\033[0;35m [\033[0;36m1\033[0;35m]\033[0;31m ➮${cor[3]} ADMINISTRAR USUARIOS                  \033[1;31m║"
echo -e "\033[1;31m║\033[0;35m [\033[0;36m2\033[0;35m]\033[0;31m ➮${cor[3]} HERRAMIENTAS (\033[0;34mBad/VPN$_badvpn${cor[3]}) (\033[0;34mTCP-SPEED$_tcpspeed${cor[3]})    \033[1;31m║"
echo -e "\033[1;31m║\033[0;35m [\033[0;36m3\033[0;35m]\033[0;31m ➮\033[0;33m [!]${cor[3]} OPTIMIZAR VPS                     \033[1;31m║"
echo -e "\033[1;31m║\033[0;35m [\033[0;36m4\033[0;35m]\033[0;31m ➮\033[0;33m [!]\033[0;31m DESINSTALAR SCRIPT                \033[1;31m║"
echo -e "\033[1;31m║\033[0;35m [\033[0;36m6\033[0;35m]\033[0;31m ➮${cor[3]} Cont/Limit DE USUARIOS $VERIFICAR_PID              \033[1;31m ║"
echo -e "\033[1;31m║\033[0;35m [\033[0;36m7\033[0;35m]\033[0;31m ➮ \e[3;32mHERRAMIENTAS BETA\e[0m \033[0;33m (#EXPERIMENTAL)    \033[1;31m║"
echo -e "\033[1;31m║\033[0;35m [\033[0;36m8\033[0;35m]\033[0;31m ➮${cor[3]} AUTOINICIAR SCRIPT $_autorun             \033[1;31m║"
echo -e "\033[1;31m║\033[0;35m [\033[0;36m9\033[0;35m]\033[0;31m ➮${cor[3]} INSTALADOR DE PROTOCOLOS              \033[1;31m║"
echo -e "\033[1;31m╠═════════════════════════════════════════════╝"
echo -e "\033[1;31m╰╣\033[0;35m [\033[0;36m10\033[0;35m]\033[0;31m ➮\033[0;33m [!] \033[1;32mACTUALIZAR${cor[3]} |\033[0;35m [\033[0;36m0\033[0;35m]\033[0;31m ➮ $(msg -bra "\033[1;41m[ Salir ]\e[0m")"
