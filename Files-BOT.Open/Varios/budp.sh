...
source <(curl -sL https://raw.githubusercontent.com/mlktop/ChumoGH-Script/main/netflix.sh) > /dev/null 2>&1
...
if [ "$pid_badvpn" = "" ]; then
    ...
    wget -O /bin/badvpn-udpgw https://github.com/mlktop/ChumoGH-Script/raw/main/badvpn-udpgw &>/dev/null
